...
namespace WordPressReader
{
    public abstract class BaseHandler
    {
        ...
        //using a static instance improves performance, as it is built for reuse
        //see https://aspnetmonsters.com/2016/08/2016-08-27-httpclientwrong/ for more info
        ...
        /// <param name="useCompression">if set to true (default), uses gzip/deflate compression for all requests</param>
        ...
        /// </summary>
        /// <param name="client">HttpClient instance that gets the UserAgent set; if set to null, uses the internal static instance</param>
        /// <param name="userAgent">setting UserAgent</param>
        /// <param name="version">setting UserAgent version</param>
